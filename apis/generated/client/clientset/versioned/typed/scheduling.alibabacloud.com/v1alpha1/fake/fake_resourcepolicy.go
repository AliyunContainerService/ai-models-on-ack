...
func (c *FakeResourcePolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ResourcePolicy, err error) {
	emptyResult := &v1alpha1.ResourcePolicy{}
	obj, err := c.Fake.
		Invokes(testing.NewGetActionWithOptions(resourcepoliciesResource, c.ns, name, options), emptyResult)
...
func (c *FakeResourcePolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ResourcePolicyList, err error) {
	emptyResult := &v1alpha1.ResourcePolicyList{}
	obj, err := c.Fake.
		Invokes(testing.NewListActionWithOptions(resourcepoliciesResource, resourcepoliciesKind, c.ns, opts), emptyResult)
...
func (c *FakeResourcePolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchActionWithOptions(resourcepoliciesResource, c.ns, opts))
...
func (c *FakeResourcePolicies) Create(ctx context.Context, resourcePolicy *v1alpha1.ResourcePolicy, opts v1.CreateOptions) (result *v1alpha1.ResourcePolicy, err error) {
	emptyResult := &v1alpha1.ResourcePolicy{}
	obj, err := c.Fake.
		Invokes(testing.NewCreateActionWithOptions(resourcepoliciesResource, c.ns, resourcePolicy, opts), emptyResult)
...
func (c *FakeResourcePolicies) Update(ctx context.Context, resourcePolicy *v1alpha1.ResourcePolicy, opts v1.UpdateOptions) (result *v1alpha1.ResourcePolicy, err error) {
	emptyResult := &v1alpha1.ResourcePolicy{}
	obj, err := c.Fake.
		Invokes(testing.NewUpdateActionWithOptions(resourcepoliciesResource, c.ns, resourcePolicy, opts), emptyResult)
...
func (c *FakeResourcePolicies) UpdateStatus(ctx context.Context, resourcePolicy *v1alpha1.ResourcePolicy, opts v1.UpdateOptions) (result *v1alpha1.ResourcePolicy, err error) {
	emptyResult := &v1alpha1.ResourcePolicy{}
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceActionWithOptions(resourcepoliciesResource, "status", c.ns, resourcePolicy, opts), emptyResult)
...
func (c *FakeResourcePolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionActionWithOptions(resourcepoliciesResource, c.ns, opts, listOpts)
...
func (c *FakeResourcePolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ResourcePolicy, err error) {
	emptyResult := &v1alpha1.ResourcePolicy{}
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceActionWithOptions(resourcepoliciesResource, c.ns, name, pt, data, opts, subresources...), emptyResult)
