...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	switch resource {
	// Group=scheduling.alibabacloud.com, Version=v1alpha1
	case v1alpha1.SchemeGroupVersion.WithResource("resourcepolicies"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Scheduling().V1alpha1().ResourcePolicies().Informer()}, nil
