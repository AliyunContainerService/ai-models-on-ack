...
// Package v1 contains API Schema definitions for the kai.alibabacloud.com v1 API group
...
var (
	...
	GroupVersion = schema.GroupVersion{Group: "kai.alibabacloud.com", Version: "v1"}
...
func ResourceWithName(name string) schema.GroupResource {
	return SchemeGroupVersion.WithResource(name).GroupResource()
}
